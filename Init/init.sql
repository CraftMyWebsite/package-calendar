...
INSERT INTO `cmw_calendar_settings` (`calendar_settings_webhook_new_event`, `calendar_settings_use_webhook_new_event`, `calendar_settings_locale`,
                                     `calendar_settings_dayMaxEventRows`, `calendar_settings_height`, `calendar_settings_use_nowIndicator`,
                                     `calendar_settings_initialView`, `calendar_settings_updated`) VALUES
                                    (NULL, '0', 'fr', '3', '650', 1, 'dayGridMonth', current_timestamp());